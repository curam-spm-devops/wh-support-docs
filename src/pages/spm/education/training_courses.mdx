...
For an up-to-date list of current courses with pricing, please review the latest announcement: [Cúram Education Mar 2025.pdf](/pdf/education/Mar2025Newsletter.pdf)
...
### CUR099_A Merative Cúram Express Rules for Developers Knowledge Assessment ###

+ **Duration:** 20 hours approx

+ **Course description:** This assessment offers students a chance to prove their knowledge of Cúram Express Rules by taking a test and demonstrating their ability to implement a real-world change to an Eligibility and Entitlement ruleset.
...
+ **Audience:** This assessment is aimed at developers who have completed the CUR099 Merative Cúram Express Rules for Developers V8.X course.

+ **Prerequisites:** As a minumum, it is recommended that students taking this assessment will have completed the CUR099 Merative Cúram Express Rules for Developers V8.X course.
