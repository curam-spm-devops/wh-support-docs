...
### CUR086 Merative Cúram on Kubernetes for Developers ###

+ **Duration:** 16 hours

+ **Course description:** This course provides the essential knowledge and resources to help technical roles implement and manage Merative Cúram deployments on Kubernetes.
