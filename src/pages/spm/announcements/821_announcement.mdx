...
Cúram by Merative™ is a leading solution for supporting the end-to-end social program and care coordination service delivery process. V8.2.1.0 includes enhancements to our user experience and new options for technical platform.
...
For more details about these features, see the [What's new in 8.2.1.0](/pdf/spm/Curam_WhatsNew_821.pdf) and the [8.2.0.0 release notes](/pdf/releasenotes/curam8200.pdf).
